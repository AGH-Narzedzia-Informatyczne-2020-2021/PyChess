...
class Knight:
    def __init__(self, color):
        self.color = color
        if self.color == WHITE:
            self.image = pg.transform.scale(pg.image.load('figures_graphics/wN.png'), (SQUARE_SIZE, SQUARE_SIZE))
        else:
            self.image = pg.transform.scale(pg.image.load('figures_graphics/bN.png'), (SQUARE_SIZE, SQUARE_SIZE))
